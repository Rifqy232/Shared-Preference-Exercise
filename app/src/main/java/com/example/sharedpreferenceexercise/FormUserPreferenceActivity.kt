...
import com.example.sharedpreferenceexercise.databinding.ActivityFormUserPreferenceBinding
...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        if (v?.id == R.id.btn_save) {
            ...
            saveUser(name, email, phoneNo, age, isLoveMU)
    ...
    private fun saveUser(name: String, email: String, phoneNo: String, age: String, isLoveMU: Boolean) {
